...
export default async function Home() {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center w-full max-w-[1285px] mx-auto">
                <h1 className="text-[40px] font-bold">
                    {homeData.data.section_one_text}
                </h1>
            <div className="mt-10">
                <div className="grid gap-10 grid-cols-1 px-5 md:p-0 md:grid-cols-3 md:gap-10 min-h-full">
                    {cards.map((c, i) => (
        ...
        <div className="flex flex-col items-center px-5 gap-10 md:px-0 md:gap-[65px] min-h-full min-w-full">
            {recentCards.map((c, i) => (
